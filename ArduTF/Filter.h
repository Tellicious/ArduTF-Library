...
{	
		public:
		FILT(double*,double,double,double,double,double,double,uint32_t);  //constructor: the parameters are Output variable,n1,n2,n3,d1,d2,d3,T (sampling time in micros) FILT(s)=(n1*s^2+n2*s+n3)/(d1*s^2+d2*s+d3)
